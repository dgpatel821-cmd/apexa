                ...
                <div className="bg-[rgba(201,168,76,0.05)] border-b border-white/[0.06] px-6 py-3 flex items-center justify-between gap-3 flex-wrap">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg bg-red-500/10 hover:bg-red-500/20 text-red-400 transition-all cursor-pointer flex items-center justify-center border border-red-500/20 hover:border-red-500/40"
